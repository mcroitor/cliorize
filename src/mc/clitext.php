...
class clitext {
    ...
    public function color(string $color): clitext {
        if (isset(self::TXT_COLOR[strtoupper($color)])) {
            $color = self::TXT_COLOR[strtoupper($color)];
        } elseif (in_array($color, self::TXT_COLOR)) {
            $color = $color;
        } else {
    ...
    public function background(string $bgcolor): clitext {
        if (isset(self::BG_COLOR[strtoupper($bgcolor)])) {
            $bgcolor = self::BG_COLOR[strtoupper($bgcolor)];
        } elseif (in_array($bgcolor, self::BG_COLOR)) {
            $bgcolor = $bgcolor;
        } else {
